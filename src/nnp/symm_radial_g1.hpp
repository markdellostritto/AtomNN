...
#include <iosfwd>
// ann - symm - radial
#include "src/nnp/symm_radial.hpp"
// ann - serialization
...
struct PhiR_G1 final: public PhiR{
	...
	inline double val(double r, double cut)const noexcept{return cut;}
	inline double grad(double r, double cut, double gcut)const noexcept{return gcut;}
};
//==== operators ====
